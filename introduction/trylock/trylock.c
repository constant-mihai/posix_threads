...
/*
 *  This definition controls how long counter_thread holds 
 *  the mutex while updating the counter. Making this number
 *  larger increases the chance that the pthread_mutex_trylock 
 *  in monitor_thread will occasionally return EBUSY.
 */
